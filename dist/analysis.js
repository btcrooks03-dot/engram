...
export function phraseMatchScore(task, text) {
...
export function analyzeDuplicates(files) {
    const pairs = [];
...
export function simulateRelevance(taskDescription, memoryDir) {
...
export function calculateEffectiveness(memoryDir) {
    const project = scanProjectMemory(memoryDir, getProjectKey(memoryDir));
    if (!project)
        return [];
