...
import { CLAUDE_DIR, MEMORY_INDEX, LINE_CAP, SIZE_CAP } from "./constants.js";
import { parseFrontmatter, extractLinks } from "./helpers.js";
export function getProjectKey(memoryDir) {
...
export function reverseProjectKey(projectKey) {
...
export function scanProjectMemory(memoryDir, projectName) {
...
export function scanClaudeMd(projectDir) {
    const files = [];
    const issues = [];
    // Global CLAUDE.md
