...
import { STORE_PATH, CHANGELOG_PATH, CHANGES_PATH, SNAPSHOTS_PATH, STOP_WORDS } from "./constants.js";
...
export function detectChanges(memoryDir) {
...
export function detectDerivableContent(memoryDir, projectDir) {
...
export function logOperation(operation, files, details) {
...
export function getChangelog(limit = 20) {
    const log = readJson(CHANGELOG_PATH) || [];
