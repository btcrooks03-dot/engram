...
import { CLAUDE_DIR, PROJECTS_DIR, DATA_DIR, MEMORY_INDEX, LINE_CAP, SIZE_CAP } from "./constants.js";
import type { MemoryFile, AuditRecord } from "./types.js";
import { ensureDir } from "./helpers.js";
import { scanProjectMemory, scanClaudeMd, getProjectKey, reverseProjectKey } from "./scanning.js";
...
server.tool(
  ...
  {},
  async () => {
    const results: import("./types.js").ProjectMemory[] = [];
