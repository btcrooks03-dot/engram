...
import type { SessionRecord, CoverageGap } from "./types.js";
...
export function logSession(topics: string[], project?: string, memoryDir?: string) {
...
export function analyzeSessionCoverage(memoryDir: string): {
